package com.belajar.restapirev.controller;
...
import com.belajar.restapirev.util.Response;
...
public class HardwareController {
	...
	ResponseEntity<Response> create (@RequestBody @Validated Hardware hardware) //mengambil request data dari body untuk melakukan proses validasi
	{
		//Informasi tentang nama Method saat ini
